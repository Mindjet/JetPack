...
import io.mindjet.jetdemo.view.activity.BottomSheetBehaviorActivity;
...
import io.mindjet.jetdemo.view.activity.SandwichWebViewActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        textResList.add(io.mindjet.jetdemo.R.string.sandwich_web_view);
        ...
        intentList.add(SandwichWebViewActivity.intentFor(this));
